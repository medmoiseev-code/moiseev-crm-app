...
export const defaultSystemSettings = () => ({ version:1, clinicName:'Axio SRM', logo:'A', brandColor:'#6c8cff', workStart:'09:00', workEnd:'18:00', workDays:[1,2,3,4,5], holidays:[], taskTypes:[], patientStatuses:[], commentTemplates:[], taskTemplates:[], transferReasons:[], refusalFollowupMonths:6, checkupAfterTreatmentMonths:6, treatmentControlDays:7, rolePermissions:{ admin:['patients','tasks','worktime'], manager:['all'] }, defaultTheme:'moiseev' })
